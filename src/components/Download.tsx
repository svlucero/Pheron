  ...
  return (
    <section id="download" className="py-24 bg-[#0f172a] text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-[#8b5cf6]/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        <div className="inline-flex items-center gap-2 bg-white/10 border border-white/10 text-sm font-medium px-3 py-1.5 rounded-full mb-8">
          <DownloadIcon className="w-3.5 h-3.5 text-[#8b5cf6]" />
          Free during beta
        </div>
        ...
        <a
          href="#"
          className="inline-flex items-center gap-2 bg-[#8b5cf6] hover:bg-[#7c3aed] text-white font-semibold px-8 py-4 rounded-full text-lg transition-colors shadow-lg shadow-[#8b5cf6]/20"
        >
          ...
          <div className="rounded-2xl border border-white/10 overflow-hidden max-w-2xl mx-auto">
            ...
            <div className="aspect-video bg-gradient-to-br from-gray-900 to-gray-800 flex flex-col items-center justify-center gap-4 p-8">
              <div className="w-14 h-14 rounded-2xl bg-[#8b5cf6]/20 flex items-center justify-center">
                <DownloadIcon className="w-7 h-7 text-[#8b5cf6]" />
              </div>
