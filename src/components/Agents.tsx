            ...
            return (
              <div
                ...
                className={`group p-6 rounded-2xl border transition-all ${
                  agent.isCta
                    ? "border-dashed border-[#6d28d9]/40 hover:border-[#6d28d9] bg-[#f3f0ff] cursor-pointer"
              ...
              >
                ...
                {agent.isCta && (
                  <div className="mt-4 text-sm font-medium text-[#6d28d9] flex items-center gap-1 group-hover:gap-2 transition-all">
                    Create custom agent →
                  </div>
                )}
              </div>
